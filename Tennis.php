...
p{
  padding-bottom: 0;
       ...
       <form  class="" action="Tennis_Confirm.php" method="POST">
...
<!-- <button onclick="delUsers();" class="del_another_field btn btn-danger btn-md">Delete Racquet </button> -->
           ...
           <div style="text-align:center;margin-left:30%;margin-top:5%;visibility:hidden;">
             ...
             <div class="container String" style="float:center">
              ...
              <input style="float:right;margin-top:10%;margin-left:50%" class="btn btn-primary btn-lg "type="Submit" name="Tennis_submit" value="Proceed to Confirm" onclick="addProducts()">
              </div>
