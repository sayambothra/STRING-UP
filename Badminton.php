...
p{
  padding-bottom: 0;
       ...
       <form  class="" action="Badminton_Confirm.php" method="POST">
         ...
         <div class="container-fluid">
                 <div class="row">
                   ...
                   <div class="col-lg-2 col-sm-2 test">


         <div class="card" style="width: 18rem;padding-top:25%;">
       <div class="card-body">
         <img src="badminton stringup-images/yonex-bg-65.jpg" class="card-img" alt="..."><br>
         <a href="#" class="btn btn-light">Yonex BG-65</a>
     ...
     <div class="card-body">
     <img src="badminton stringup-images/bg-65 titanium.jpg" class="card-img" alt="..."><br>
     <a href="#" class="btn btn-light">Yonex BG-65 Titanium</a>
    <p><strong>Rs.450/-</strong></p>
     </div>
     </div>
     ...
     <div class="card" style="width: 18rem;">
     <div class="card-body">
     <img src="badminton stringup-images/bg-66 ultimax.jpg" class="card-img" alt="..."><br>
     <a href="#" class="btn btn-light">Yonex BG-66 Ultimax</a>
    <p><strong>Rs.450/-</strong></p>
     </div>
     </div>
     ...
     <div id="row2" class="col-lg-2 col-sm-2 test">

     <div class="card" style="width: 18rem;padding-top:30%;">
     <div class="card-body">
     <img src="badminton stringup-images/nanogy-95.jpg" class="card-img" alt="..."><br>
     <a href="#" class="btn btn-light">Yonex Nanogy 95</a>
    <p><strong>Rs.450/-</strong></p>
     </div>
     </div>
     ...
     <div class="card" style="width: 18rem;">
     <div class="card-body">
     <img src="badminton stringup-images/aerosonic.jpg" class="card-img" alt="..."><br>
     <a href="#" class="btn btn-light">Yonex Aerosonic</a>
     <p><strong>Rs.450/-</strong></p>
     </div>
     </div>
     ...
     <div class="card" style="width: 18rem;">
     <div class="card-body">
     <img src="badminton stringup-images/aerobyte.jpg" class="card-img" alt="..."><br>
     <a href="#" class="btn btn-light">Yonex Aerobite</a>
  <p><strong>Rs.450/-</strong></p>
     </div>
     </div>
...
<!-- <button onclick="delUsers();" class="del_another_field btn btn-danger btn-md">Delete Racquet </button> -->
           ...
           <div id="row2" class="col-lg-2 col-sm-2 test">
             ...
             <div class="card" style="width: 18rem;padding-top:30%;">
             <div class="card-body">
             <img src="badminton stringup-images/Ln7.jpg" class="card-img" alt="..."><br>
             <a href="#" class="btn btn-light">Lining No.7</a>
            <p><strong>Rs.450/-</strong></p>
             </div>
             </div>
             ...
             <div class="card" style="width: 18rem;">
             <div class="card-body">
             <img src="badminton stringup-images/Lining no.1.jpg" class="card-img" alt="..."><br>
             <a href="#" class="btn btn-light">Lining No.1</a>
            <p><strong>Rs.450/-</strong></p>
             </div>
             </div>
             ...
             <div class="card" style="width: 18rem;">
             <div class="card-body">
             <img src="badminton stringup-images/lining ln 70 poster.jpg" class="card-img" alt="..."><br>
             <a href="#" class="btn btn-light">Lining No.70</a>
          <p><strong>Rs.450/-</strong></p>
             </div>
             </div>
             ...
             <div class="card" style="width: 18rem;padding-top:30%;">
             <div class="card-body">
             <img src="badminton stringup-images/lining ln 62.jpg" class="card-img" alt="..."><br>
             <a href="#" class="btn btn-light">Lining No.62</a>
          <p><strong>Rs.450/-</strong></p>
             </div>
             </div>
             ...
             <div class="card" style="width: 18rem;">
             <div class="card-body">
             <img src="badminton stringup-images/ln64 poster.jpg" class="card-img" alt="..."><br>
             <a href="#" class="btn btn-light">Lining No.64</a>
          <p><strong>Rs.450/-</strong></p>
             </div>
             </div>
             ...
             <!-- <div class="card" style="width: 18rem;">
             <div class="card-body">
             <img src="aerobyte.jpg" class="card-img" alt="..."><br>
             <a href="#" class="btn btn-dark">Yonex Aerobyte</a>
             <p>Rs.450/-</p>
             </div>
             </div> -->
           ...
           <div style="text-align:center;margin-left:30%;margin-top:5%;visibility:hidden;">
             ...
             <div class="container String" style="float:center">
              ...
              <input style="float:right;margin-top:10%;margin-left:50%" class="btn btn-primary btn-lg "type="Submit" name="Badminton_submit" value="Proceed to Confirm" onclick="addProducts()">
              </div>
