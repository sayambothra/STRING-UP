...
.top{
 ...
 <form name="myform"class="top" method="POST">
   <div class="container-fluid" id="DeliveryBoy">
     <div class="row">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img class="ss"src="squash.jpg" alt="Squash" width="100%" height="400px">
    </div>
  </div>
  ...
  <a class="carousel-control-next" href="#demo" data-slide="next">
    <span class="carousel-control-next-icon"></span>
     ...
     <label class="detail"><strong>User-Name</strong></label>


     <input id="Uname"class="detail"type="text" name="playersName" value="" required>

     <br>

       <label class="detail"><strong>Password</strong></label>
         <input id="Pwd"class="detail"type="text" name="stadium" value="" required><br>
      <button onclick="togglesection();"type="button" style="margin-left:20%"class="btn btn-success" name="button">Sign-In</button>
     </section>
    ...
    <div  style="text-align:center;visibility: hidden;"class="container "id="Sports">
      <h3>Select Sports</h3><br>
    ...
    <div class="card-body">
      <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsJvE6BXdulnrznMCngHv0RftAVJBUjWPRtQ&usqp=CAU" alt="">
       <!-- <button type="button" onclick=userdetails() name="button">Badminton</button> -->
        ...
        <button type="button" class="btn btn-success"name="button"onclick="window.location.href='Badminton_Report.php'">Badminton</button>
...
<div class="col-lg-4 d-flex justify-content-center">
  <div class="card text-black bg-light sm-3" style="max-width: 18rem;">
    <div class="card-body">
     ...
     <button type="button" class="btn btn-success"name="button"onclick="window.location.href='Tennis_Report.php'">Tennis</button>
  </div>
</div>
</div>
<br>
...
<div class="card text-black bg-light sm-3" style="max-width: 18rem;">
  ...
  <div class="card-body">
    ...
    <button type="button" name="button"class="btn btn-success"onclick="window.location.href='Squash_Report.php';">Squash</button>
  </div>
</div>
</div>
  ...
  if(username =='STRING-UP' && PassWord=='Billiondollar$'){
    document.getElementById("Sports").style.visibility="visible";
    var myobj = document.getElementById("DeliveryBoy");
    myobj.remove();
    // document.getElementById("Sports").style.flex-wrap="wrap";
