      ...
      <body>
        ...
        <div style="text-align:center">
          ...
          <?php
            ...
            $amount;
          if($RbrandLen>1)
            {$Cdetails="Dear ".$name."\n"."Your following Squash Racquets:\n<br>";
          ...
          $Tamount=$amount;
          $Cdetails="Dear ".$name."\n"."Your ".$Rbrand[0]." ".$Rmodel[0]. " Squash Racquet will be collected from ".$Arena."\n<br> today between ".$PickupTime."<br>It will be
        ...
        <form style="margin-left:46%"target="_blank"action="Squash_Confirm.php"method="POST">
      ...
      if(isset($_POST['confirmed'])){
        ...
        VALUES('$NAME','$ARENA','$TEL','Squash')";
          ...
          $stringcolor=count($RCOLOR);
            ...
            $sql1="INSERT INTO squash_racquets(Name,Tel_number,Arena,RacquetQuantity,RacquetBrand,RacquetModel,StringType,
            ...
            if($Rbrand>1){
                $message="Dear ".$NAME." , Your following Squash Racquets:\n";
                for($i=0;$i<$Rbrand;$i++){
                    $j=$i+1;
                ...
                $message.="are booked for stringing on ".$CDATE." from ".$ARENA." at ".$PTIME.".These Racquets will be Strung and delivered back to you by tomorrow at ".$ARENA." between ".$PTIME.". Your Total Charges Payable are Rs. ".$TamounT." only/-. Thanks for choosing thestringup.com(STRING-UP)!!!";
                  ...
                  $message="Dear ".$NAME." ,Your Squash Racquet ".$BRAND." ".$MODEL." is booked for stringing service On ".$CDATE.
