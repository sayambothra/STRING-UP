...
<link href="https://fonts.googleapis.com/css2?family=Ubuntu:wght@500&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
      ...
      <body>
        ...
        <div style="text-align:center">
          ...
          <?php
            ...
            $amount;
          if($RbrandLen>1)
            {$Cdetails="Dear ".$name."\n"."Your following Tennis Racquets:\n<br>";
          ...
          $Tamount=$amount;
          $Cdetails="Dear ".$name."\n"."Your ".$Rbrand[0]." ".$Rmodel[0]. " Tennis Racquet will be collected from ".$Arena."\n<br> today between ".$PickupTime."<br>It will be
        ...
        <form style="margin-left:46%"target="_blank"action="Tennis_Confirm.php"method="POST">
      ...
      if(isset($_POST['confirmed'])){
        ...
        $Sport=$_POST['Sport'];
        //echo $BRAND;
        $sql="INSERT INTO Customer_details(Serial_no,Name,Arena,Tel_number,Sport)
        VALUES('','$NAME','$ARENA','$TEL','Tennis')";
          ...
          $stringcolor=count($RCOLOR);
            ...
            $sql1="INSERT INTO tennis_racquets(Name,Tel_number,Arena,RacquetQuantity,RacquetBrand,RacquetModel,StringType,
            StringTension,StringColor,RacquetCover,CollectionDate,PickUpTime,Amount)
            VALUES('$NAME','$TEL','$ARENA','$NRQ','$BRAND','$MODEL','$STRING','$TENSION','$COLOR','$Rcover','$CDATE','$PTIME','$TamounT')";



        if($Rbrand>1){
            $message="Dear ".$NAME." , Your following Tennis Racquets:\n";
            for($i=0;$i<$Rbrand;$i++){
                $j=$i+1;
            ...
            $message.="are booked for stringing on ".$CDATE." from ".$ARENA." at ".$PTIME.".These Racquets will be Strung and delivered back to you by tomorrow at ".$ARENA." between ".$PTIME.". Your Total Charges Payable are Rs. ".$TamounT." only/-. Thanks for choosing thestringup.com(STRING-UP)!!!";
              ...
              $message="Dear ".$NAME." ,Your Tennis Racquet ".$BRAND." ".$MODEL." is booked for stringing service On ".$CDATE.
